...
private extension StubbedDataItemLoader {
    private var page0: [Item] {
        return [
            ...
            Item(name: "Harry Potter and the Order of the Phoenix",
    ...
    private var page2: [Item] {
        return [
            Item(name: "The Winds of Winter",
                 description: "The Winds of Winter is the planned sixth novel in the epic fantasy series A Song of Ice and Fire by American writer George R. R. Martin. Martin believes the last two volumes of the series will total over 3,000 manuscript pages. Martin has refrained from making hard estimates for the novel's final release date after several delays. In October 2022, Martin stated he had completed approximately three-quarters of the novel.[1][2] subsequently estimating that he had written approximately 1,100 to 1,200 pages of the novel, and had roughly 400 - 500 pages left.",
                 price: 330,
                 timestamp: Date.init(),
                 imageName: "book.circle"),
            Item(name: "Dune",
